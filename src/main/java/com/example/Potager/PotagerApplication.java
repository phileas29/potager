...
public class PotagerApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		potagers.add(new Potager("Lesquidic", "Jardins Phil√©asiens", 250000, "Gouesnac'h"));
		potagers.add(new Potager("Toul ar C'Hoat", "Cl√©ment's Meadows", 800000, "Le Faou"));
		...
		plantes.add(new Plante("Èpinard",EnumType.FEUILLE,"gÈant d'hiver",20));
